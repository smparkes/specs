...
If the XML runner is run on a composite specification{executeCompositeSpecRunner} it must then {"create a specification element containing the sub-specifications:\n" +
